...
class AvailabilityService {
  ...
  static setAvailabilityForAdvisor(advisorId, availabilities, cb) {
    async.eachLimit(availabilities, 10, (availability: any, callback) => {
      ...
      Availability.update({ date: dateObject }, newAvailability, { upsert: true, setDefaultsOnInsert: true }, callback);
    }, cb)
